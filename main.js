...
const part = table.slice(4, 6);//başlangıç bitiş
console.table(part);
// console.table(table);
...
const foundUser = table.find((user) => user.id === '7asdk901');
const foundUser2 = table.find((user) =>{ return user.id === '7asdk901'});
console.log('Bulundu', foundUser);
console.log('Bulundu', foundUser2);
//* forEach
...
const decide = (user) => ({
  ...
  name: 'berkan', //user.point + 200,
  point: user.point+250,
});
